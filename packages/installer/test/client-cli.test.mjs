...
test('client-only setup with no optional integrations still acquires the host CLI', async () => {
  ...
  const profile = { serverUrl: 'https://server.example', endpoint: 'https://server.example/daemon', expectedInstanceId: '12345678-1234-1234-1234-123456789abc', credentialPath: '/home/me/.ours-client/credential', installer: { sourcesPath: sources, integrations: [] } };
